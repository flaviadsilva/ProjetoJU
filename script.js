document.addEventListener('DOMContentLoaded', () => {
    ...
    const audienceTexts = {
        ...
        'hospitais': `
            ...
            <p>As práticas propostas aliviam o estresse crônico, fortalece o vínculo entre colegas e resgata a leveza necessária para que o atendimento ao paciente aconteça com mais presença e humanidade.</p>
        `,
        'escolas': `
            <h4>🏫 ESCOLAS</h4>
        ...
        'sociais': `
            ...
            <p>O Pulsar também atua em espaços que vivem o cuidado coletivo como ONGs, associações e grupos sociais.</p>
